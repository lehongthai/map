                    ...
                    <div class="card">
                        ...
                        <div class="body">
                           ...
                           <label for="user_id">Nhân viên</label>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="receiver_name" class="form-control" placeholder="Nhập họ tên" name="receiver_name" value="{!! old('receiver_name', $infoOrder->receiver_name) !!}">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="receiver_phone" class="form-control" placeholder="Nhập số điện thoại" name="receiver_phone" value="{!! old('receiver_phone',$infoOrder->receiver_phone) !!}">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="receiver_address" class="form-control" placeholder="Nhập địa chỉ người nhận" name="receiver_address" value="{!! old('receiver_address',$infoOrder->receiver_address) !!}">
                                    </div>
